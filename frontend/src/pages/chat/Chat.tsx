                        ...
                        {!lastQuestionRef.current ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>A-Lex Supercharged</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>This chatbot is configured to answer branch offices questions about temporary staffing</h2>
                            </Stack>
                        ) : (
